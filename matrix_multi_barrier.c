...
void* multiply(void* slice)
{
    ...
    // each thread's barrier will be wait for other threads' barrier
    // until number which was given when initialize
...
int main(int argc, char* argv[])
{
    ...
    // initialize pthread_barrier_t variable
    // barrier will be wait until num_thrd * barriers all end
    pthread_barrier_init(&barrier, NULL, num_thrd);
    ...
    // destroy pthread_barrier_t variable
